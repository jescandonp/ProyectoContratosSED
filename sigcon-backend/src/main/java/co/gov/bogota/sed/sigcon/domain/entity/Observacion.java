...
@Entity
@Table(name = "SGCN_OBSERVACIONES")
@EntityListeners(AuditingEntityListener.class)
public class Observacion {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "observaciones_seq")
    @SequenceGenerator(name = "observaciones_seq", sequenceName = "SGCN_OBSERVACIONES_SEQ", allocationSize = 1)
    @Column(name = "ID")
    private Long id;
    ...
    public RolObservacion getAutorRol() {
        return autorRol;
    }

    public void setAutorRol(RolObservacion autorRol) {
