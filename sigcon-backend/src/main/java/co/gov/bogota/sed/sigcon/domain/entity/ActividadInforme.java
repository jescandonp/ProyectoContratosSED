...
@Entity
@Table(name = "SGCN_ACTIVIDADES")
@EntityListeners(AuditingEntityListener.class)
public class ActividadInforme {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "actividades_seq")
    @SequenceGenerator(name = "actividades_seq", sequenceName = "SGCN_ACTIVIDADES_SEQ", allocationSize = 1)
    @Column(name = "ID")
    private Long id;
