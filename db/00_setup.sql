...
-- ============================================================
-- ===== INCREMENTO 4 — Revisor opcional, edición contrato ===
-- ============================================================

-- ----- Extender SGCN_CONTRATOS con revisor opcional -----
ALTER TABLE SGCN_CONTRATOS ADD (
    ID_REVISOR  NUMBER
);

ALTER TABLE SGCN_CONTRATOS ADD CONSTRAINT FK_CONTRATOS_REVISOR
    FOREIGN KEY (ID_REVISOR) REFERENCES SGCN_USUARIOS(ID);

-- ----- Extender SGCN_INFORMES con fechas editables -----
-- FECHA_INICIO y FECHA_FIN ya existen desde I2; se documentan como editables via PATCH.


-- ============================================================
-- ===== INCREMENTO 6 — PDF Institucional + Datos Complementarios
-- ============================================================
...
CREATE TABLE SGCN_APORTES_SGSSI (
    ...
    CONSTRAINT CHK_APORTES_SGSSI_ITEM
        CHECK (ITEM IN ('SALUD','PENSION','ARL')),
    CONSTRAINT CHK_APORTES_SGSSI_ACTIVO
        CHECK (ACTIVO IN (0,1))
);
...
-- CLAVE_LOGICA: identifica el tipo de documento; 'FACTURA' es dinamico por IVA.
CREATE SEQUENCE SGCN_DOCS_REQUERIDOS_SEQ START WITH 1 INCREMENT BY 1 NOCACHE;
...
CREATE INDEX IDX_DOCS_REQUERIDOS_INFORME ON SGCN_DOCS_REQUERIDOS(ID_INFORME);
CREATE INDEX IDX_DOCS_REQUERIDOS_CLAVE   ON SGCN_DOCS_REQUERIDOS(ID_INFORME, CLAVE_LOGICA);
